...
if(isset($_GET['error'])){
  ...
  else if($_GET['error'] == "NoCompany"){
    echo "<script type='text/javascript'>alert('Company name could not be found');</script>";
  }
}?>
<html lang="en">
<head>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-7 col-md-6">
          <h2>Sign Up as a Company Representative</h2>
          <form action="signUp_action.php" method="post" role="form" onSubmit="return checkPassword(this)">
            ...
            <div class="form-group">
              <label for="JobTitle"><br>Job Title</br></label>
              <input type="text" placeholder="Job Title" name="jobTitle" >
              <div class="col-lg-5 col-md-6">
                  <textarea rows = "5" cols = "50" placeholder="Enter your Contact Information Here" name = "contact_info"></textarea>
              </div>
              <div class="text-center"><button type="submit" title="Sign Up" name="signUpSubmitRepresentative">Sign Up</button></div>
          </form>
        </div>
    </div>
  </section>
